...
void USART_SendDataDMA(USART_RegDef_t *pUSARTx,
                       uint8_t *pTxBuffer,
                       uint32_t Len);

void USART_ReceiveDataDMA(USART_RegDef_t *pUSARTx,
                          uint8_t *pRxBuffer,
                          uint32_t Len);
...
#define DMA1_Channel6_BASEADDR  (DMA1_BASEADDR + 0x6C)
#define DMA1_Channel7_BASEADDR  (DMA1_BASEADDR + 0x80)

#define DMA1_CLK_EN()   (RCC->AHB1ENR |= (1 << 0))
#define DMA2_CLK_EN()   (RCC->AHB1ENR |= (1 << 1))

#define DMA1_CLK_DI()   (RCC->AHB1ENR &= ~(1 << 0))
#define DMA2_CLK_DI()   (RCC->AHB1ENR &= ~(1 << 1))
...
#define DMA1_Channel6 ((DMA_Channel_TypeDef *)DMA1_Channel6_BASEADDR)
#define DMA1_Channel7 ((DMA_Channel_TypeDef *)DMA1_Channel7_BASEADDR)
