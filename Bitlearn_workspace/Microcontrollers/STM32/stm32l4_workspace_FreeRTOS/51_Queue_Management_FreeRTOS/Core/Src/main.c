...
QueueHandle_t command_queue = NULL, uart_write_queue = NULL;

uint8_t usr_msg[250] = {0};
...
int main(void)
{
  ...
  //create write queue
  uart_write_queue = xQueueCreate(10,sizeof(uint8_t*));
